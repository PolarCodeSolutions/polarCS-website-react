...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://www.polarcode.solutions/images/tjenester/webhosting.webp",
        width: 800,
        height: 600,
...
const BlogDetailsPage: React.FC = () => {
  const shareUrl = 'https://www.polarcode.solutions/tjenester/webhosting';
  ...
  return (
    <>
      <Head>
        ...
        />
        <meta property="og:url" content="https://www.polarcode.solutions/tjenester/webhosting" />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://www.polarcode.solutions/images/tjenester/webhosting.webp" />
